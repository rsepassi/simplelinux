...
export SLROOT=$PWD
export INITRD_PATH=$SLROOT/sources/build/initramfs.cpio.gz
export INITRD_TAR_PATH=$SLROOT/sources/build/initramfs.tar.gz
export IMG_PATH=$SLROOT/sources/build/simplelinux.img
export KERNEL_PATH=$SLROOT/sources/build/kernel
export BUSYBOX_PATH=$SLROOT/sources/build/busybox
